...
{
    private:
        string a;  //highest_qulification_in_general_education
        string b;  //highest_professional_qulification
    public:
        void get_education(string v,string r)
        {
            a=v,b=r;
        }
        void show_education()
        {
            cout<<"highest qulification in general education: "<<a<<endl;
            cout<<"highest professional qulification: "<<b<<endl;
...
int main()
{
    ...
    a.get_education("bachelor","head");
    officer b("Maxin","002",'S');
    b.get_education("master","manager");
